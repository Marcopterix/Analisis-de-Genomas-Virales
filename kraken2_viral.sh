...
echo -e "######################################################################################################################" "\n"
echo -e  ========= Determinación de abundancia de especies con Bracken en secuencias virales ========== "\n"
echo -e "\t" ===== Inicio: $(date) ===== "\n"
echo -e "######################################################################################################################" "\n"

#---------------------------------------------------------
dirfq="/home/admcenasa/Analisis_corridas/Archivos_postrim/virus"
dirout="/home/admcenasa/Analisis_corridas/kraken2/virus"
dirbrackout="/home/admcenasa/Analisis_corridas/Bracken/virus"
#---------------------------------------------------------
...
ImportTaxonomy.pl -t 5 -s 1 -m 3 ${k2} -o ${dirbrackout}/${ID}_kraken2_krona.html
